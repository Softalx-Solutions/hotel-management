            ...
            <div className="max-w-sm mx-auto px-4 py-8">
              ...
              <form>
                ...
                <div className="flex items-center justify-between mt-6">
                  <div className="mr-1">
                    <Link className="text-sm underline hover:no-underline" to="/home">Home Page</Link>
                  </div>
                  <Link className="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3" to="/home">Sign In</Link>
                </div>
              </form>
              {/* Footer */}
